    ...
    <div className="space-y-6">
      <div className="flex flex-col md:flex-row gap-4 items-center justify-between">
        <div className="group flex flex-col">
          ...
          <p className="text-xs text-zinc-500 font-medium">Logs detalhados de todas as ações no sistema</p>
        </div>
      ...
      <div className={cn(
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className={cn(
                ...
                <th className="px-6 py-4 text-[10px] font-black uppercase tracking-widest text-zinc-500">Evento / Data</th>
                <th className="px-6 py-4 text-[10px] font-black uppercase tracking-widest text-zinc-500 hidden sm:table-cell">Colaborador</th>
                <th className="px-6 py-4 text-[10px] font-black uppercase tracking-widest text-zinc-500">Detalhes da Ação</th>
          ...
          {filteredLogs.length === 0 && (
            <div className="p-20 text-center text-zinc-500 italic flex flex-col items-center gap-3">
