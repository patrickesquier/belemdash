        ...
        <div className="flex items-center gap-2 p-1 rounded-lg md:p-1.5 md:rounded-xl bg-slate-500/5 border border-slate-500/10">
          <button 
            ...
            className={cn(
              ...
              isDarkMode ? "text-slate-500 hover:text-white hover:bg-slate-800" : "text-slate-500 hover:text-slate-900"
            )}
            title="Calculadora"
          >
            <Calculator size={16} />
          ...
          >
            <Bell size={16} />
            {logs.length > 0 && (
              <span className="absolute top-2 right-2 w-1.5 h-1.5 bg-red-500 rounded-full border border-[#020617]" />
            )}
          </button>
        </div>

        <div className="flex items-center gap-4 md:pl-6 md:border-l md:border-slate-700/30">
          ...
          <div className={cn(
            ...
            <div className="w-6 h-6 md:w-7 md:h-7 rounded bg-slate-700 flex items-center justify-center">
